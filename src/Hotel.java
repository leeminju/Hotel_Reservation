...
//        reservationMap.put(uuid, new Reservation(uuid, roomlist[SUITE], temp, "2023-10-25"));
//        uuid = UUID.randomUUID();
//        reservationMap.put(uuid, new Reservation(uuid, roomlist[DELUE], temp, "2023-07-25"));
//        uuid = UUID.randomUUID();
